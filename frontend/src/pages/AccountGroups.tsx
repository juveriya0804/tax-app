  ...
  return (
    <div style={{ padding: '20px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
        <div>
          <h1 className="text-gradient">Account Groups</h1>
          <p className="text-muted" style={{ marginTop: '8px' }}>Manage your chart of accounts grouping.</p>
        </div>
      ...
      <div className="glass-panel" style={{ padding: '40px', textAlign: 'center', color: 'var(--text-muted)' }}>
        No account groups defined. Click "Create Group" to get started.
      </div>
    </div>
  );
}
