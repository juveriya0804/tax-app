  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        customerName: customers.find(c => c.id === formData.customerId)?.name || (formData.customerId === 'walkin' ? 'Walk-in Customer' : 'Walk-in Customer'),
      ...
      localStorage.setItem('salesOrders', JSON.stringify([payload, ...existing]));
  ...
  return (
    <div style={{ padding: '0 0 20px 0', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
        ...
        <h1 className="text-gradient" style={{ fontSize: '2rem', margin: 0 }}>Create SalesOrder</h1>
      </div>
