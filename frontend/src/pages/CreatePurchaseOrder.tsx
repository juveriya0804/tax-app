...
import { ArrowLeft, Edit2, Plus, Settings, X, ChevronDown, Percent, Hash, TableProperties, Copy, Search, Scale, Image as ImageIcon, Eye, Tag, PlusSquare, EyeOff } from 'lucide-react';
    ...
    <div style={{ padding: '0 0 60px 0', maxWidth: '1200px', margin: '0 auto', background: '#fafafa', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'white', borderBottom: '1px solid rgba(0,0,0,0.05)', padding: '16px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ position: 'relative', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '16px' }}>
          ...
          <h1 style={{ fontSize: '1.4rem', fontWeight: 600, color: '#334155', margin: 0 }}>Create New Purchase Order</h1>
        </div>
      ...
      <div style={{ padding: '40px 24px' }}>
        <form onSubmit={handleSubmit} style={{ background: 'white', borderRadius: '8px', padding: '40px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '48px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <h2 style={{ fontSize: '2rem', fontWeight: 700, color: '#334155', margin: 0, borderBottom: '2px dashed #cbd5e1', paddingBottom: '4px' }}>Purchase Order</h2>
              <Edit2 size={16} color="var(--text-secondary)" style={{ cursor: 'pointer', marginLeft: '8px' }} />
            </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '40px' }}>
            ...
            {/* Left Column */}
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '550px' }}>
              
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ width: '180px' }}>
                  <label style={{ color: '#475569', fontWeight: 500, borderBottom: '1px dashed #cbd5e1', paddingBottom: '4px', display: 'inline-block' }}>Purchase Order No<span style={{ color: '#ef4444' }}>*</span></label>
                </div>
                <input 
                  type="text" 
                  value={formData.poNo}
                  onChange={e => setFormData({...formData, poNo: e.target.value})}
                  style={{ flex: 1, border: 'none', borderBottom: '1px solid #e2e8f0', padding: '8px 0', outline: 'none', fontSize: '1rem', color: '#1f2937', marginLeft: '16px' }}
                />
              </div>

              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ width: '180px' }}>
                  <label style={{ color: '#475569', fontWeight: 500, borderBottom: '1px dashed #cbd5e1', paddingBottom: '4px', display: 'inline-block' }}>P.O. Date<span style={{ color: '#ef4444' }}>*</span></label>
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ width: '180px' }}>
                  <label style={{ color: '#475569', fontWeight: 500, borderBottom: '1px dashed #cbd5e1', paddingBottom: '4px', display: 'inline-block' }}>Due Date</label>
                </div>
            ...
            <div style={{ display: 'flex', gap: '24px', marginBottom: '24px' }}>
              ...
              <div style={{ flex: 1, background: '#f8fafc', borderRadius: '8px', padding: '24px', border: '1px solid #f1f5f9' }}>
                <h3 style={{ margin: '0 0 16px 0', fontSize: '1.2rem', color: '#1e293b', borderBottom: '1px dashed #cbd5e1', paddingBottom: '8px', display: 'inline-block' }}>
                  Order By <span style={{ fontSize: '0.9rem', color: '#64748b', fontWeight: 'normal' }}>(Your Details)</span>
                </h3>
              ...
              <div style={{ flex: 1, background: '#f8fafc', borderRadius: '8px', padding: '24px', border: '1px solid #f1f5f9' }}>
                <h3 style={{ margin: '0 0 16px 0', fontSize: '1.2rem', color: '#1e293b', borderBottom: '1px dashed #cbd5e1', paddingBottom: '8px', display: 'inline-block' }}>
                  Order To <span style={{ fontSize: '0.9rem', color: '#64748b', fontWeight: 'normal' }}>(Vendor's Details)</span>
                </h3>
          ...
          <div style={{ marginTop: '48px', border: '1px solid #e2e8f0', borderRadius: '8px', overflow: 'hidden' }}>
            ...
            <div style={{ background: '#fafafa', padding: '16px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '3fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr', gap: '16px', alignItems: 'center', marginBottom: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', borderBottom: '1px solid #e2e8f0', paddingBottom: '8px' }}>
                  <input type="text" placeholder="Item Name / SKU Id" style={{ flex: 1, border: 'none', outline: 'none', fontSize: '0.95rem', color: '#334155', background: 'transparent' }} />
                  <Hash size={14} color="#94a3b8" style={{ margin: '0 8px' }} />
                  <Search size={14} color="#94a3b8" />
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '8px' }}>
                  <input type="text" defaultValue="0" style={{ width: '100%', border: 'none', outline: 'none', fontSize: '0.95rem', color: '#334155', background: 'transparent' }} />
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '8px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                  ...
                  <input type="text" defaultValue="1" style={{ width: '100%', border: 'none', outline: 'none', fontSize: '0.95rem', color: '#334155', background: 'transparent' }} />
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '8px' }}>
                  <input type="text" defaultValue="1" style={{ width: '100%', border: 'none', outline: 'none', fontSize: '0.95rem', color: '#334155', background: 'transparent' }} />
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '350px' }}>
                <div style={{ display: 'flex', gap: '32px' }}>
                  <button type="button" style={{ background: 'none', border: 'none', color: '#64748b', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontSize: '0.95rem' }}>
                    <PlusSquare size={16} color="#8b5cf6" /> Add Description
                  </button>
                  <button type="button" style={{ background: 'none', border: 'none', color: '#64748b', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontSize: '0.95rem' }}>
            ...
            {/* Bottom Actions */}
            <div style={{ display: 'flex', gap: '16px', padding: '16px', background: 'white', borderTop: '1px solid #f1f5f9' }}>
              <button type="button" style={{ flex: 1, padding: '14px', background: 'white', border: '1px dashed #cbd5e1', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', color: '#64748b', fontWeight: 500, cursor: 'pointer', fontSize: '0.95rem' }}>
                <PlusSquare size={18} color="#8b5cf6" /> Add New Line
              </button>
              <button type="button" style={{ flex: 1, padding: '14px', background: 'white', border: '1px dashed #cbd5e1', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', color: '#64748b', fontWeight: 500, cursor: 'pointer', fontSize: '0.95rem' }}>
                <PlusSquare size={18} color="#8b5cf6" /> Add New Group
              </button>
            </div>
          </div>
          ...
          <div style={{ marginTop: '32px', display: 'flex', justifyContent: 'flex-end' }}>
            <div style={{ width: '400px', background: '#fafafa', padding: '24px', borderRadius: '12px' }}>
              {/* Top part */}
              ...
              {/* Words Total Block */}
              <div style={{ background: 'white', padding: '20px', borderRadius: '8px', border: '1px solid #f1f5f9' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
